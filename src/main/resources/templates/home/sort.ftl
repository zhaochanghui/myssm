    ...
    <div class="col-sm-9 col-md-9">
        ...
        <div class="art_content">
            ...
            <div class="text-c mb-20" id="moreBlog">
                <#if prev==true >
                      <a href="/sort?sort=${sort}&page=${page-1}" class="f-r"><input class="btn btn-success size-S" type="button" value="上一页"></a>
                <#else>
                 <a href="" class="f-r" onclick="return false;"><input class="btn btn-success size-S" type="button" value="上一页"></a>
                </#if>

                  <#if next==true >
                      <a href="/sort?sort=${sort}&page=${page+1}" class="f-r"><input class="btn btn-success size-S" type="button" value="下一页"></a>
                  <#else>
